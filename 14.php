    ...
    <section class="how-it-works-sec">
        <div class="section-title text-center">
            <a href="13.php">&laquo;Previous Child</a>
            <h2>14th Saul Nagwere<span class="pink"> Lineage</span></h2>
            <a href="15.php">Next Child&raquo;</a>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="step-works wow fadeInLeft" wow-data-delay="0.4s">
                    <div class="content-section">
                        ...
                        <ul class="nav navbar-nav navbar-left cus-navbar">
                            <li class="dropdown"><a href="#">Hi Children</a>
                                <ul class="sub-service dropdown-content">
                                    <li>Kid 1</li>
                                    <li>Kid 2</li>
                                    <li>Kid 3</li>
