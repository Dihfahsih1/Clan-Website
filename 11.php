    ...
    <section class="how-it-works-sec">
        <div class="section-title text-center">
            <a href="10.php">&laquo;Previous Child</a>
            <h2>11th Wabulo Charles aka Mushedu<span class="pink"> Lineage</span></h2>
            <a href="12.php">Next Child&raquo;</a>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="step-works wow fadeInLeft" wow-data-delay="0.6s">
                    <div class="content-section book-sec">
                        ...
                        <a href="https://www.dihfahsih.blogpost.ug/"><h4>Wambedde aka Bondyo</h4></a>
                        <div class="works-img enjoy">
                            <img src="images/2.jpg">
                        </div> 
             ...
             <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="step-works wow fadeInLeft" wow-data-delay="0.6s">
                    <div class="content-section book-sec">
                        ...
                        <h4>Annonymous Sons and daughters</h4>
                        <div class="works-img enjoy">
                            <img src="images/2.jpg">
                        </div> 
                        <p>Heis the seventh born</p> 
                         <ul class="nav navbar-nav navbar-left cus-navbar">
                            <li class="dropdown"><a href="#">His Children</a>
                                <ul class="sub-service dropdown-content">
                                    <li>Kid 1</li>
