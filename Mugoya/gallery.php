  ...
  <main class="hoc container clear"> 
      <div id="gallery">
          ...
          <ul class="nospace clear">
           <li class="one_quarter1" ><a href="#"><img src=" images/2.jpg" style="width:100%; height: 60%;" alt=""></a></li>
            <li class="one_quarter1"><a href="#"><img src=" images/1.jpg" style="width:100%; height: 60%;"alt=""></a></li>
            <li class="one_quarter1"><a href="#"><img src=" images/3.jpg"style="width:100%; height: 60%;" alt=""></a></li>
            <li class="one_quarter1"><a href="#"><img src=" images/4.jpg"style="width:100%; height: 60%;" alt=""></a></li>
      ...
      <nav>
        ...
        <ul class="nav navbar-nav navbar-left cus-navbar" style="margin-left: 50%;font-size: 27px;">  
          <li><a href="#">1</a></li>
          <a href="gallery2.php" class="next">Next &raquo;</a>
        </ul>
      </nav>
  </main>
</div>
