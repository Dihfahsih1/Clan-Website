    ...
    <section class="how-it-works-sec">
        <div class="section-title text-center">
            <a href="18.php">&laquo;Previous Child</a>
            <h2>19th Assuman Mugamba<span class="pink"> Lineage</span></h2>
            <p>He was the last child of Wagima</p>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="step-works wow fadeInLeft" wow-data-delay="0.4s">
                    <div class="content-section">
                        <h4>He has approximately 12 Children</h4>
                        <div class="works-img enjoy">
                            <img src="images/2.jpg">

                        </div>    
                        <p>Most of them are not known</p>
