    ...
    <section class="how-it-works-sec">
        <div class="section-title text-center">
            <a href="7.php">&laquo;Previous Child</a>
            <h2>8th Assuman Mugamba<span class="pink"> Lineage</span></h2>
            <a href="9.php">Next Child&raquo;</a>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="step-works wow fadeInLeft" wow-data-delay="0.4s">
                    <div class="content-section">
                        <h4>Silver Mugoya aka BBoko</h4>
                        <div class="works-img enjoy">
                            <img src="images/2.jpg">

                        </div>    
                        <p>He is the only son of the Late</p>
