					                                ...
					                                <table class="table table-bordered">
					                                    ...
					                                    <tbody>
					                                        <tr>
					                                            ...
					                                            <td>+919907234590</td>
					                                            <td class="emp-link">
					                                            	<a href="saloon-employee-list.php">James</a>
					                                            </td>
					                                            <td>Hair Cutting</td>
					                                        ...
					                                        <tr>
					                                            ...
					                                            <td>+919907234590</td>
					                                            <td class="emp-link">
					                                            	<a href="saloon-employee-list.php">Mary</a>
					                                            </td>
					                                        ...
					                                        <tr>
					                                            ...
					                                            <td>+919807234590</td>
					                                            <td class="emp-link">
					                                            	<a href="saloon-employee-list.php">John</a>
					                                            </td>
					                                            <td>Skin</td>
					                                            <td>12:30 PM - 1:00 PM</td>
					                                            <td>Completed</td>
					                                        ...
					                                        <tr>
					                                            ...
					                                            <td>+919565234590</td>
					                                            <td class="emp-link">
					                                            	<a href="saloon-employee-list.php">Smith</a>
					                                            </td>
					                                            <td>Skin</td>
					                                            <td>12:30 PM - 1:00 PM</td>
					                                            <td>Completed</td>
		            			...
		            			<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
	                                ...
	                                <div class="row">
	                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
	                                        ...
	                                        <input class="form-control input-medium date-picker" size="16" type="text" value="15/11/2017"/>
	                                    </div>
	                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
