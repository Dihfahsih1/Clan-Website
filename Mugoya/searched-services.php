                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <h4 class="header-heading">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="index.php">Services Page</a>
                            </li>
                        </ul>
                    </h4>
                    <div class="row">
                                ...
                                <div class="filter-content">
                                    ...
                                    <div class="service-list-sec">
                                        <div class="wrap-service">
                                                ...
                                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                                    <div class="service-inner-des">
                                                        <h5 class="name-saloon">
                                                            <a href="javascript:void(0);">Sasha Beauty Salon (Ladies)</a>
                                                        </h5>
                                                        ...
                                                        <ul class="rating-points">
                                                            <li>
                                                                ...
                                                                <span class="star-number">(18)</span>
                                                            </li>
                                                            <li>
                                            ...
                                            <div class="esact-service">
                                                <div class="searched-service">
                                                    <ul class="searched-ul">
                                                        <li>
                                                            <span class="service-name">
                                                                Haircut 
                                                                <span class="time-on"><i class="fa fa-clock-o"></i> 30 Min</span>
                                                            </span>
                                                ...
                                                <div class="searched-service relevant-de2">
                                                    <ul class="searched-ul">
                                                        <li>
                                                            <span class="service-name">
                                                                Hair Color
                                                                <span class="time-on"><i class="fa fa-clock-o"></i> 40 Min</span>
                                                            </span>
                                                            <span class="price-and-book">
                                                                <span class="price-nub">AED 300
                                                                </span>
                                                                <span class="book-btn">
                                                                    <a class="btn cus-btn" href="javascript:void(0);">Book</a>
                                                                </span>
                                        ...
                                        <div class="wrap-service">
                                            <div class="img-content-sec">
                                                ...
                                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                                    <div class="service-inner-des">
                                                        <h5 class="name-saloon">
                                                            <a href="javascript:void(0);">Platinum Black Beauty Salon</a>
                                                        </h5>
                                                        <address>9566 Destiny USA Dr E208, Syracuse, NY 13290, USA</address>
                                                        <ul class="rating-points">
                                                            <li>
                                            ...
                                            <div class="esact-service">
                                                ...
                                                <!-- <div class="searched-service relevant-de">
                                                    <ul class="searched-ul">
                                                        <li>
                                                            <span class="service-name">
                                                                Child Hair Cut (10 year and below) 
                                                                <span class="time-on"><i class="fa fa-clock-o"></i> 15 Min</span>
                                                            </span>
                                                            <span class="price-and-book">
                                                                <span class="price-nub">AED 40
                                        ...
                                        <div class="wrap-service">
                                            <div class="img-content-sec">
                                                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 p-l-0">
                                                    <div class="service-img">
                                                        <img src="img/service-3.jpg" class="img-responsive">
                                                    </div>
                                                </div>
                                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                                    <div class="service-inner-des">
