      ...
      <div id="first">
        <ul class="nospace clear">
         <li class="one_quarter1"><a href="#"><img src=" images/10.jpg"style="width:100%; height: 60%;" alt=""></a></li>
          ...
          <li class="one_quarter1"><a href="#"><img src=" images/17.jpg"style="width:100%; height: 60%;" alt=""></a></li>
          <li class="one_quarter1"><a href="#"><img src=" images/18.jpg" style="width:100%; height: 60%;"alt=""></a></li>
          <li class="one_quarter1"><a href="#"><img src=" images/19.jpg"style="width:100%; height: 60%;"style="width:100%; height: 60%;" alt=""></a></li>
          <li class="one_quarter1"><a href="#"><img src=" images/20.jpg" style="width:100%; height: 60%;" alt=""></a></li>
        </ul>
      </div>
  </div>
    <nav>
      <h6 style="margin-left: 50%;"> See more in our gallery</h6>
        ...
        <li><a href="gallery.php" class="previous">&laquo; Previous</a></li>
        <li><a href="#">2</a></li>
        <a href="gallery3.php" class="next">Next &raquo;</a>
    </ul>
    </nav></div>
</main>
</div>
